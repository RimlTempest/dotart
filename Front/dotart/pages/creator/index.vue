          ...
          <v-col cols="12">
            <v-card light hover max-width="1000" class="justify-center">
              <v-form ref="form" lazy-validation>
                <v-card-title class="justify-center">ドット絵作成</v-card-title>
              </v-form>
            </v-card>
          </v-col>
          ...
          <v-col cols="12">
            <v-card light hover max-width="1000" class="justify-center">
              <v-form ref="form" lazy-validation>
                ...
                <v-text-field 　label="キャンバス名" v-model="canvasName" />
              </v-form>
            </v-card>
          </v-col>
          ...
          <v-col cols="12">
            <v-card light hover max-width="1000" class="justify-center">
              <v-form ref="form" lazy-validation>
                ...
                <v-card-actions>
                  <v-spacer />
                  <v-btn color="primary" @click="startDraw">start</v-btn>
                </v-card-actions>
              </v-form>
            </v-card>
          </v-col>
...
export default class CreatorPage extends Vue {
  ...
  startDraw(): void {
    ...
    canvasDataModule.setCanvasMagnification(this.selectedSize['magnification'])
